...
/*
  use `Exclude<T, undefined>` to mark return value
  as not undefined. However, if it is undefined,
  the runtime error will occur.
*/
export function swap<T, U>(v1: T, v2: U): [Exclude<U, undefined>, Exclude<T, undefined>] {
  return [v2 as Exclude<U, undefined>, v1 as Exclude<T, undefined>];
}
